...
int main()
{
    ...
    long data = 123456789071; // ввод исходных данных
    ...
    {
        short var2_p1 = data >> 8 & 0b0000000011111111; //старший байт
        short var2_p2 = data >> 8 & 0b1111111100000000; //младший байт
        var2 = var2_p1 + var2_p2;
    }
