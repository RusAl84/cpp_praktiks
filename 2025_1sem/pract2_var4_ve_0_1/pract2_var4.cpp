...
// смысл в том что вместо X для BYTE_TO_BINARY(X) выводится 8 знаков '0' или '1' соответствующих передаваемму числу X в формате byte (типа byte)
...
int main()
{
    ...
    long data = 1234567890; // ввод исходных данных
    ...
    short var1_p1 = data >> 16 & 0b1111111100000000; //старший байт
    short var1_p2 = data & 0b0000000011111111; //младший байт
    short  var1 = var1_p1 + var1_p2;
    short N = 2;  // тут задается N
    ...
    short var2;
    short n_bit = var1 >> N & 0b0000000000000001;
    //printf("n_bit = %d\n", n_bit );
    if (n_bit == 1)
    {
        short var2_p1 = data >> 8 & 0b1111111100000000; //старший байт
        short var2_p2 = data >> 8 & 0b0000000011111111; //младший байт
        var2 = var2_p1 + var2_p2;
    }
    else
    {
        short var2_p1 = data >> 16 & 0b0000000011111111; //старший байт
        short var2_p2 = data & 0b1111111100000000; //младший байт
        var2 = var2_p1 + var2_p2;
    }
